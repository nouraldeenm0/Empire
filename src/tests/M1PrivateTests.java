...
// ############################################# Classes' Paths  ############################################# //
	...
	testInstanceVariableIsPresent(Class.forName(cityPath), "militaryBuildings", true);
	testInstanceVariableIsPrivate(Class.forName(cityPath), "militaryBuildings");
	testInstanceVariableOfType(Class.forName(cityPath), "militaryBuildings", ArrayList.class);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityMilitaryBuildingsGetter() throws ClassNotFoundException {
	testGetterMethodExistsInClass(Class.forName(cityPath), "getMilitaryBuildings", ArrayList.class, true);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityMilitaryBuildingsSetter() throws ClassNotFoundException {
	testSetterMethodExistsInClass(Class.forName(cityPath), "setMilitaryBuildings", ArrayList.class, false);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityMilitaryBuildingsGetterLogic() throws Exception {
    ...
    @Test(timeout = 100)
    public void testConstructorCityConstructorInitialization() throws Exception {
	Constructor<?> constructor = Class.forName(cityPath).getConstructor(String.class);
	int random = (int) (Math.random() * 50);
	String name = "name" + random;
	Object myObj = constructor.newInstance(name);
    ...
    @Test(timeout = 100)
    public void testInstanceVariableCityNameSetter() throws ClassNotFoundException {
	testSetterMethodExistsInClass(Class.forName(cityPath), "setName", String.class, false);
    }
	...
	testInstanceVariableIsPresent(Class.forName(cityPath), "economicalBuildings", true);
	testInstanceVariableIsPrivate(Class.forName(cityPath), "economicalBuildings");
	testInstanceVariableOfType(Class.forName(cityPath), "economicalBuildings", ArrayList.class);
    }
	...
	testInstanceVariableIsPresent(Class.forName(cityPath), "turnsUnderSiege", true);
	testInstanceVariableIsPrivate(Class.forName(cityPath), "turnsUnderSiege");
	testInstanceVariableOfType(Class.forName(cityPath), "turnsUnderSiege", int.class);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityTurnsUnderSiegeGetter() throws ClassNotFoundException {
	testGetterMethodExistsInClass(Class.forName(cityPath), "getTurnsUnderSiege", int.class, true);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityTurnsUnderSiegeSetter() throws ClassNotFoundException {
	testSetterMethodExistsInClass(Class.forName(cityPath), "setTurnsUnderSiege", int.class, true);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityUnderSiege() throws Exception {
	testInstanceVariableIsPresent(Class.forName(cityPath), "underSiege", true);
	testInstanceVariableIsPrivate(Class.forName(cityPath), "underSiege");
	testInstanceVariableOfType(Class.forName(cityPath), "underSiege", boolean.class);
    }

    @Test(timeout = 100)
    public void testInstanceVariableCityUnderSiegeGetter() throws Exception {
	testGetterMethodExistsInClass(Class.forName(cityPath), "isUnderSiege", boolean.class, true);
    }
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitCurrentSoldierCountGetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitCurrentSoldierCountGetterLogic() throws Exception {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitCurrentSoldierCountSetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitSiegeUpkeepGetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitSiegeUpkeepGetterLogic() throws Exception {
	Constructor<?> archerConstructor = Class.forName(archerPath).getConstructor(int.class, int.class, double.class,
		double.class, double.class);
	int random1 = (int) (Math.random() * 4);
	int random2 = (int) (Math.random() * 50);
    ...
    @Test(timeout = 100)
    public void testInstanceVariableUnitSiegeUpkeepSetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableArmyDistancetoTargetGetter() throws ClassNotFoundException {
	testGetterMethodExistsInClass(Class.forName(armyPath), "getDistancetoTarget", int.class, true);
    }

    @Test(timeout = 100)
    public void testInstanceVariableArmyDistancetoTargetGetterLogic() throws Exception {
	Constructor<?> armyConstructor = Class.forName(armyPath).getConstructor(String.class);
	int random = (int) (Math.random() * 50);
    ...
    @Test(timeout = 100)
    public void testInstanceVariableArmyDistancetoTargetSetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testInstanceVariableArmyMaxToHoldGetter() throws ClassNotFoundException {
	testGetterMethodExistsInClass(Class.forName(armyPath), "getMaxToHold", int.class, true);
    }

    @Test(timeout = 100)
    public void testInstanceVariableMaxToHoldGetterLogic() throws Exception {
	Constructor<?> armyConstructor = Class.forName(armyPath).getConstructor(String.class);
	int random = (int) (Math.random() * 50);
	Object a = armyConstructor.newInstance("Location_" + random);
    ...
    @Test(timeout = 100)
    public void testInstanceVariableArmyMaxToHoldSetter() throws ClassNotFoundException {
    ...
    @Test(timeout = 100)
    public void testConstructorCavalryConstructor() throws Exception {
    ...
    @Test(timeout = 1000)
    public void testConstructorCavalryConstructorInitialization() throws Exception {
	Constructor<?> constructor = Class.forName(cavalryPath).getConstructor(int.class, int.class, double.class,
		double.class, double.class);
	int random1 = (int) (Math.random() * 4);
	int random2 = (int) (Math.random() * 50);
	double random3 = (double) (Math.random() * 50);
	...
	testInstanceVariableIsPresent(Class.forName(distancePath), "to", true);

	testInstanceVariableIsPrivate(Class.forName(distancePath), "to");
	testInstanceVariableOfType(Class.forName(distancePath), "to", String.class);
    }
	...
	testInstanceVariableIsPresent(Class.forName(gamePath), "distances", true);

	testInstanceVariableIsPrivate(Class.forName(gamePath), "distances");
	testInstanceVariableOfType(Class.forName(gamePath), "distances", ArrayList.class);
    }
